...
# -*- coding: utf-8 -*-
#
# ipyp5 documentation build configuration file
#
...
_version_py = os.path.join(repo, "ipyp5", "_version.py")
version_ns = {}
...
latex_documents = [
    (master_doc, "ipyp5.tex", "ipyp5 Documentation", "Jeremy Tuloup", "manual")
]
...
man_pages = [(master_doc, "ipyp5", "ipyp5 Documentation", [author], 1)]
